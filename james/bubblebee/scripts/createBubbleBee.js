...
//for local testing 
var scriptURL = "http://localhost:8080/scripts/bubbleBee.js?" + randInt(0, 10000);
...
var beeMaker = Entities.addEntity({
    type: "Box",
    position: center,
    dimensions: {
        x: 1,
...
function cleanup() {
    Entities.deleteEntity(beeMaker);
    Script.update.disconnnect(saySomething)
}
